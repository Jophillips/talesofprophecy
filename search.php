<?php
	...
	if($search!=''){
		...
		if($by=='id'){
			...
			$r3=mysql_query($q2)or die("FAILED TO EXECUTE QUERY");
			$x=mysql_num_rows($r1);
		}
		...
		for($i=1;$i <= $x;$i++){
			...
			$r4=mysql_query($q4)or die("FAILED TO EXECUTE QUERY");
			...
			echo" HP";
			echo "</td><td>";
			echo "<font color='CCCCCC'>Level: </font>";
			echo $o4['level'];
			echo "</td><td>";
			...
			echo "</td><td>";
			echo "<font color='CCCCCC'>Division: </font>";
			echo $o4['division'];
			echo "</td><td>";
