<?php
	...
	$result=mysql_query($query)or die("FAILED TO EXECUTE QUERY1");
	...
	/*shows banners*/	/*SHOWS THE REGISTER PAGE*/
	...
	if($reregister=='yes'){
		...
		echo "</p></td>";
		/*redisplays the form*/
		echo "<td bgcolor='330000' valign='top'><br><p class='text2'>Register<br>
...
VALUES ('$user','$pass','$Fname','$Lname','$email','$display')";
			$r1=mysql_query($q1)or die ("FAILED TO EXECUTE QUERY2");
			$q2="SELECT userid FROM register WHERE login='$user'";
			$r2=mysql_query($q2)or die ("FAILED TO EXECUTE QUERY3");
			$o2=mysql_fetch_array($r2,MYSQL_ASSOC);
			$id=$o2['userid'];
			$q3="INSERT INTO charinfo (userid) VALUES ('$id')";
			$r3=mysql_query($q3)or die ("FAILED TO EXECUTE QUERY4");
